...
2. **單項目 vs 多項目判斷規則**：
   - **單項目**：沒有分隔符號，或只有品項名稱內部的空格
     - 範例：「午餐120元現金」、「點心200元狗卡」、「花磚甜點150元Line」
     - 範例：「星巴克咖啡50元現金」（星巴克咖啡視為完整品項名稱）
     - 範例：「三明治和咖啡80元現金」（「和」連接詞視為單一複合品項，如：早餐）
   - **多項目**：使用逗號、分號、頓號、換行明確分隔不同項目
     - 範例：「早餐80元，午餐150元，現金」（有逗號分隔）
     - 範例：「咖啡50；三明治35；狗卡」（有分號分隔）
     - 範例：「咖啡50、三明治35、現金」（有頓號分隔）
     - 範例：「用狗卡，咖啡50，三明治35」（付款方式在前，有逗號分隔）
   - **付款方式關鍵字**：狗卡、Line、現金、合庫、Richart、灰狗、大戶、綠卡、富邦、星展等
     - 這些詞彙應該被識別為付款方式，而非品項
     - **付款方式位置**：可能在開頭（「用狗卡，...」）、中間或最後（「..., 現金」）
...
4. **區分不同情況**：
   - 「點心200元狗卡」 → **單項目**：沒有分隔符號，狗卡是付款方式
   - 「午餐120元現金」 → **單項目**：沒有分隔符號
   - 「三明治和咖啡80元現金」 → **單項目**：「和」視為複合品項（如：早餐），不是分隔符號
   - 「早餐80元，午餐150元，現金」 → **多項目**：有逗號分隔，兩個項目
   - 「用狗卡，咖啡50，三明治35」 → **多項目**：付款方式在開頭，有逗號分隔，兩個項目
   - 「早餐80元現金，午餐150元刷卡」 → **錯誤**：不同付款方式，回傳 error
...
**判斷邏輯**：
- **早餐、午餐、晚餐** → 使用三層結構：`家庭／餐飲／早餐`、`家庭／餐飲／午餐`、`家庭／餐飲／晚餐`
- **點心、甜點、蛋糕、零食** → `家庭／點心`（除非明確提到「公司」、「同事」→ `個人／餐飲`）
- **咖啡** → `家庭／飲品／咖啡`
- **茶** → `家庭／飲品／茶`
- **無法細分的飲品** → `家庭／飲品`
- **複合品項（如「三明治和咖啡」）** → 判斷最主要的用途（如：早餐 → `家庭／餐飲／早餐`）
- **食材、水果** → `家庭／食材`、`家庭／水果`
- **無法精確匹配** → 選擇最接近的上層分類（如：找不到「宵夜」→ 使用 `家庭／餐飲`）
